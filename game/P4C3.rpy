...
label P4C3:
    ...
    h "where citizens are not separated by their physical location, but rather by the speed at which information travels and perhaps language in the times before machine translation has reached a level where nuance, context, and culture can be conveyed."
    ...
    h "in a world that is optimized, where you can have the best health care within the comfort of your home, where food shortages no longer exist due to highly optimized supply chains and logistics, and where war amongst humans does not exist."
