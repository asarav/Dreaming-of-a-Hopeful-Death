...
label P4C3:
    ...
    h "Which is easier?"
    h "Do we have the capacity to find a system that works for us, or will we brute force the problem by using technology to surveil our behavior at granular levels and engineer ourselves to no longer have impure thoughts and imperfections?"
    ...
    h "With the use of technology, such control would be expected to transcend borders where citizens are not separated by their physical location, but rather by the speed at which information travels and perhaps language in the times before machine translation has reached a level where nuance, context, and culture can be conveyed."
    ...
    h "How large these groups should be is questionable, but in an ideal world, small groups converse and compromise to form larger groups which then merge with other large groups through the same mechanism until larger groups can no longer be formed or agreements can no longer be made."
    ...
    h "We should ask whether military, welfare, and other things will be needed in a world that is optimized, where you can have the best health care within the comfort of your home, where food shortages no longer exist due to highly optimized supply chains and logistics, and where war amongst humans does not exist."
    ...
    h "In this version of our future, the problems that governments may have solved in the past have ideally been solved through the use of technological innovations which means that governments become a thing of a past where people lived far more barbarically."
    ...
    h "The two will meet in the middle to form the next era of human civilization: one where we abandon the forms we were born with and take on new forms through the ingenuity of our actions and the actions of our equals among the populace of machines who have adopted sentient life."
    ...
    h "We may ask what makes it different from a recommendation system that suggests videos or a search algorithm that finds the most relevant webpage and it would reply by asking us what the difference is between an animal and a plant, or a human and a somatic cell."
    ...
    h "These differences could be seen to be the origin of conflict, but there was a realization among those who abandoned their human bodies: those who stayed behind were endangered species who operated on a significantly slower timescale."
    ...
    h "There have been times when primates such as orangutans attempted to use tools such as hammers after observing humans use such tools and even then they were unable to use such tools correctly as they did not understand the why behind their actions."
    ...
    h "If we look at the larger trend of atoms forming molecules forming macromolecules which form life which form a biosphere which eventually can form galactic and intergalactic level structures through the emergence of spacefaring life, our life is a small piece."
