...
label P4C2:
    ...
    h "Will it be individual parts of me that drop off like flies, or will it be a memory of a person here and thought from another person here? Will I cease to remember that I am the entirety of a species, or will I begin to believe that I am one human separated from the rest? What will I be at the end of this? I don't know, but the closest thing to the loss of all thought that I am aware of is brain death."
    ...
    h "If given an infinite amount of time, could it be possible that we can be reborn through completely random processes like a work of Shakespeare born from typewriters operated by monkeys with no time limit? Maybe there are many people who are waiting to be reborn in a new form that transcends the biological and physical substrate we are so familiar with."
    ...
    h "Do we have a duty as the last of our kind to remember those who came before us? I don’t know."
    h "Should we not remember them so that they do not die a second death? Or is that simply entrapment? Would we instead have been made prisoners of the dead who no longer concern themselves with the living? It is likely."
    h "If the dead could speak, would they say anything differently that what we already have? I think not."
